...
-- Table `cl19467`.`sexo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cl19467`.`sexo` ;

CREATE TABLE IF NOT EXISTS `cl19467`.`sexo` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `cl19467`.`modalidade_edicao_status`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cl19467`.`modalidade_edicao_status` ;

CREATE TABLE IF NOT EXISTS `cl19467`.`modalidade_edicao_status` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `cl19467`.`modalidade_edicao` (
  ...
  CONSTRAINT `fk_modalidade_edicao_edicao`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_modalidade_edicao_modalidade_edicao_status`
    FOREIGN KEY (`modalidade_edicao_status_id`)
    REFERENCES `cl19467`.`modalidade_edicao_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `cl19467`.`aluno_modalidade_disposicao`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cl19467`.`aluno_modalidade_disposicao` ;

CREATE TABLE IF NOT EXISTS `cl19467`.`aluno_modalidade_disposicao` (
  `modalidade_id` INT NOT NULL,
  `usuario_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_aluno_modalidade_disposicao_modalidade`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_aluno_modalidade_disposicao_usuario`
    FOREIGN KEY (`usuario_id`)
    REFERENCES `cl19467`.`usuario` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `cl19467`.`modalidade_regras`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cl19467`.`modalidade_regras` ;

CREATE TABLE IF NOT EXISTS `cl19467`.`modalidade_regras` (
  `modalidade_id` INT NOT NULL,
  `descricao` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`modalidade_id`),
  CONSTRAINT `fk_modalidade_regras_modalidade`
    FOREIGN KEY (`modalidade_id`)
    REFERENCES `cl19467`.`modalidade` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
